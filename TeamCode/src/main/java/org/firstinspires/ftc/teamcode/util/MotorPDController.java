 ...
 * @author Jackson
 */
public class MotorPDController implements HardwareDevice {
    ...
    protected PDController positionController = new PDController(1, 1);
     ...
     */
    public MotorPDController(@NonNull HardwareMap hMap, String id) {
     ...
     */
    public MotorPDController(@NonNull HardwareMap hMap, String id, @NonNull GoBILDA gobildaType) {
     ...
     */
    public MotorPDController(@NonNull HardwareMap hMap, String id, double cpr, double rpm) {
        this(hMap, id, GoBILDA.NONE);
    ...
    public double getPositionDerivativeCoefficent(){
    ...
    public void setPositionDerivativeCoefficient(double kd) {
    ...
    public String getDeviceType() {
        return "MotorPDController " + motor.getDeviceName() + " from " + motor.getManufacturer()
                + " in port " + motor.getPortNumber();
    }

    /**
     * Stops motor movement. MotorPDController can be moved again by calling set without having to re-enable the
     * motor.
     */
