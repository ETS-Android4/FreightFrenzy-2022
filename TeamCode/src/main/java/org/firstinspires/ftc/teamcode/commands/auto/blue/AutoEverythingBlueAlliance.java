...
public class AutoEverythingBlueAlliance extends SequentialCommandGroup {
    public AutoEverythingBlueAlliance(MecanumDriveSubsystem dt, CarouselSubsystem car,
