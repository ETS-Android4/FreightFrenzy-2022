...
public class AutoCarouselWarehouseBlueAlliance extends SequentialCommandGroup {
    public AutoCarouselWarehouseBlueAlliance(MecanumDriveSubsystem dt, CarouselSubsystem car,
