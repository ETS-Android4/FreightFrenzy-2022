...
public class AutoCarouselStorageUnitRedAlliance extends SequentialCommandGroup {
    public AutoCarouselStorageUnitRedAlliance(MecanumDriveSubsystem dt, CarouselSubsystem car,
